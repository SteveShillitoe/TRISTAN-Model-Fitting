...
# read in .csv file containing DCE signals dataset
filename = "/Users/sirishatadimalla/Desktop/Code - Python/WP2-RatDataAnalysis/MSD_Rat5_01.csv"
...
plt.plot(time,blood_conc,'.r',time,spleen_conc,'.g',time,liver_conc,'.b')
